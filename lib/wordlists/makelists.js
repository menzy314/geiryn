...
function getWelshLetters( form, lemma ) {
	...
	var rhng = [ 'arholi', 'bangaw', 'bingo', 'byrhau', 'cwango', 'dengar', 'dyfrhau', 'engram', 'genglo', 'glingam', 'gorhoffi', 'gwarhau', 'hwyrhau', 'ingot', 'jingo', 'jyngl', 'lingri', 'llengar', 'llengig', 'llwfrhau', 'manglo', 'mango', 'mawrhau', 'mingam', 'parhad', 'parhau', 'pengoch', 'rhangor', 'sarhad', 'sarhau', 'sbangl', 'sicrhau', 'siwrhau', 'tango', 'ungell', 'ungnwd', 'ungorn' ];
	if ( !form.match( /^[a-zâêîôûŵŷäëïöüẅÿáéíóúẃýàèìòùẁỳ]*$/ ) ) {
